...
// import IconArrow from "../../assets/img/f-icons/icon-arrow-light.svg";
...
export const FSiderItem = ({
  ...
  return (
    <>
      <div
        ref={submenuRef}
        className={`${variant ? `f-sider-item-${variant}` : 'f-sider-item'} ${children ? "has-child" : ""} ${subMenu ? "submenu-open" : ""
          } ${className} ${location.pathname.split("/").join("") === title.toLowerCase()
            ? "active"
            : ""
          } `}
      >
