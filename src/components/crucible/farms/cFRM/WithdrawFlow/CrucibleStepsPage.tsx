        ...
        <ul>
          <li className="step step-success">
            <span className="step-info">
              ...
              <FTypo>
                Congratulations! You have successfully withdrawn your cFRM
          ...
          <li>
            <span className="step-info">
              ...
              <FTypo>
                ...
                now able to stake your cFRM LP tokens to start earning rewards!
              </FTypo>
              <br></br>
              <FInputCheckbox
                ...
                className="f-mb-1 f-mt-1"
                label={
                  "I have added liquidity of cFRM / BNB pair and have the LP tokens. I’m ready to stake my cFRM LP tokens now."
                }
              />
          ...
          <li className="step-last">
            <FButton
              ...
              onClick={() =>
                history.push({
                  pathname: PATH_DASHBOARD.crucible.cFRM.stake.stake,
                })
              }
            />
          </li>
