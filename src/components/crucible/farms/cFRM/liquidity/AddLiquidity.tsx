        ...
        <ul>
          <li className="step step-success">
            <span className="step-info">
              ...
              <FTypo>Congratulations! You have successfully minted your cFRMx reward tokens! Please proceed to step 2.
          ...
          <li>
            <span className="step-info">
              ...
              In order to deposit LP tokens into the cFRMx LP Farm (cFRMx/BNB pair), you will first need to add liquidity.               
                ...
                <br></br>
                After you add liquidity, you will need to return to this screen and stake the cFRMx LP tokens.              </FTypo>
              <br></br>
              <FInputCheckbox
          ...
          <li>
            <span className="step-info">
              ...
              <FTypo>
              Congratulations! You have successfully added liquidity. You are now able to stake your APE-LP cFRMx-BNB tokens to start earning rewards!
              </FTypo>
              <br></br>
              <FInputCheckbox
