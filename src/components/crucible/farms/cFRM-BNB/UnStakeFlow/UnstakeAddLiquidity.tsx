        ...
        <div className="justify_start align_start d-flex min-100vw new-design-container-paddings-lr f-mb-3">
          <div className="custom-mr-50 f-mt-2">
            ...
            <div className={'congrats-step1-card f-mt-2'}>
              ...
              <FTypo className={"f-mb-2"} size={16} weight={700} color="#FCFCFC">Congratulations! You have successfully unstaked your {farm?.includes("cFRMx") ? "cFRMx" : "cFRM"} tokens! Please proceed to step 2.</FTypo>
            </div>
            ...
            <div className={'congrats-step3-card'}>
              ...
              <FInputCheckbox
                ...
                name="step3Check"
                className="f-mb-1 f-mt-1"
                label={`I have added liquidity of ${farm?.includes("cFRMx") ? "cFRMx" : "cFRM"} / BNB pair and have the LP tokens. I’m ready to stake my ${farm?.includes("cFRMx") ? "cFRMx" : "cFRM"
                  } LP tokens now.`}
              />
              <FButton
