...
export const Success = () => {
  ...
  const getStepCompleted = async (renderNeeded: any) => {
    ...
    try {
      ...
      console.log('updateStepsFlowStepsHistoryStatusByAssociatedUserIdByStepsFlowStepsHistoryId', 'stke success 65')
  ...
  const onMintClick = () => {
    console.log('mint click', STEP_FLOW_IDS[`${getObjectReadableFarmName("cFRMx")}`].mint)
    setIsLoading(true);
    let nextStepInfo: any;
    let newFarm: any;
    if (farm?.includes("BNB")) {
