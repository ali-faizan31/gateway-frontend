      ...
      <FCard variant={"secondary"} className="card-congrats">
        <FItem align="center">
          ...
          <FTypo size={16} className="f-mt-1">
            Congrats! You have successfully withdrawn your cFRMx reward tokens.
            You can now use the tokens to generate even more rewards by
            compounding or trading them.{" "}
          </FTypo>{" "}
        </FItem>
        <FTypo
          size={20}
