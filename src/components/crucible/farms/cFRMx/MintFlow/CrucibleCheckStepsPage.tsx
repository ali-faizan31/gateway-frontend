        ...
        <ul>
          <li className="step step-success">
            <span className="step-info">
              ...
              <FTypo>
                Congratulations! You have successfully minted your cFRMx tokens!
          ...
          <li>
            <span className="step-info">
              ...
              <FTypo>
                You are now able to stake your cFRMx tokens to start earning
                rewards!
              </FTypo>
              <br></br>
              <FInputCheckbox
                ...
                label={
                  "I understand that I have to stake my cFRMx tokens to earn cFRMx rewards."
                }
              />
              <FInputCheckbox
                ...
                className="f-mb-1 f-mt-1"
                label={
                  "I understand that rewards are generated from cFRMx trading volume. To participate in generating rewards for my staked tokens, it is recommended that some of the cFRMx tokens should be staked, while others should be used to create trading volume which generates rewards."
                }
              />
            </span>
          </li>
