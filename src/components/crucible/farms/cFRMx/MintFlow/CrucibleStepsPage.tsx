...
export const CrucibleStepsPage = () => {
  ...
  return (
    <FContainer className="f-mr-0" width={70}>
      <CrucibleMyBalance />
        ...
        <ul>
          ...
          <li>
            <span className="step-info">
              ...
              <FTypo>
                ...
                now able to stake your cFRMx LP tokens to start earning rewards!
              </FTypo>
              <br></br>
              <FInputCheckbox
                ...
                className="f-mb-1 f-mt-1"
                label={
                  "I have added liquidity of cFRMx / BNB pair and have the LP tokens. I’m ready to stake my cFRMx LP tokens now."
                }
              />
          ...
          <li className="step-last">
            <FButton
              ...
              onClick={() =>
                history.push({
                  pathname: PATH_DASHBOARD.crucible.cFRMx_BNB.stake.stake,
                })
              }
            />
          </li>
